Sparrow Recoomender System is a small industry-level movie recommender system which includes the deep learning models, feature engineering, online testing, data manipulation, etc. Different modules inside the SparrowRecSys will be added.
